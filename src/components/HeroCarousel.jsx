...
export default function AstrologyHero() {
  ...
  return (
    <section className="relative md:h-[90vh] h-[75vh] w-full overflow-hidden bg-black">
      ...
      {/* CONTENT */}
      <div className="relative z-10 h-full flex items-center justify-start max-w-7xl mx-auto px-6">
  ...
  {slides[current].title}
          ...
          <div className="flex flex-row gap-3 justify-start">
            ...
            <button
              ...
              className="px-4 py-2 text-xs sm:text-sm md:text-base bg-white text-black font-semibold rounded-full hover:bg-gray-200 transition"
            >
              View Products
            </button>
            ...
            <button
              ...
              className="px-4 py-2 text-xs sm:text-sm md:text-base border border-white text-white font-semibold rounded-full hover:bg-white hover:text-black transition"
            >
              Contact
            </button>
      ...
      <button
        onClick={prevSlide}
        className="hidden md:flex absolute left-6 top-1/2 -translate-y-1/2 text-white p-3 rounded-full border border-white/40 hover:bg-white hover:text-black transition"
      >
        <FaChevronLeft />
      </button>
      ...
      <button
        onClick={nextSlide}
        className="hidden md:flex absolute right-6 top-1/2 -translate-y-1/2 text-white p-3 rounded-full border border-white/40 hover:bg-white hover:text-black transition"
      >
        <FaChevronRight />
      </button>
